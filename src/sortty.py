...
def help_advanced():
    ...
    print("")
    print("[algorithm] uses the bubblesort algorithm, but available algorithms are: bogo bubble merge insertion quick gnome heap cocktail selection shell oddeven comb bingo radix")
    print("")
    print("If you want a custom array size and array range, you can do so like this:")
    print("sortty 0 3 100 bubble 30 20")
    print("")
...
if argc == 1:
    ...
    match str(sys.argv[1]):
        ...
        case "-hs" | "--help_short":
            ...
            print("")
            print("Available algorithms: bogo bubble merge insertion quick gnome heap cocktail selection shell oddeven comb bingo radix")
            print("")
            print("Example command:")
            print("sortty 0 3 100 bubble")
            print("")
